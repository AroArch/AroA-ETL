...
question_mark_words = r'(?i)illegible|unclear|unsure|not clear|unreadable|unklar|nicht erkennbar|nicht lesbar|\?+|unlesbar|unleserlich|ungenau|andere angabe'  # ^\.+|\.+$|^\*+|\*+$|^\++|\++$
...
academic_title_regex = r'\b([dD]r\.|[pP]rof\.|[mM]udr\.)'
